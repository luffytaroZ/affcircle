...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "slideshow-backend:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkslideshow_backend"] = self["webpackChunkslideshow_backend"] || [];
...
;// ./src/remotion/compositions/MinimalTheme.tsx


const MinimalTheme = ({ title, text, images = [], duration }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const safeDuration = typeof duration === "number" && isFinite(duration) && duration > 0 ? duration : 15;
  const titleDuration = Math.floor(fps * 2);
  const contentDuration = Math.max(Math.floor(fps * (safeDuration - 4)), fps);
  const outroDuration = Math.floor(fps * 2);
  const titleOpacity = (0,esm.interpolate)(frame, [0, 30], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const titleScale = (0,esm.interpolate)(frame, [0, 30], [0.8, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const contentOpacity = (0,esm.interpolate)(
    frame,
  ...
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: { backgroundColor: "#ffffff" } }, /* @__PURE__ */ react.createElement(esm.Sequence, { from: 0, durationInFrames: titleDuration + 30 }, /* @__PURE__ */ react.createElement(
    esm.AbsoluteFill,
    {
      style: {
        display: "flex",
  ...
  )), /* @__PURE__ */ react.createElement(esm.Sequence, { from: titleDuration, durationInFrames: contentDuration + 30 }, /* @__PURE__ */ react.createElement(
    esm.AbsoluteFill,
    {
      style: {
        display: "flex",
    ...
    images.length > 0 ? /* @__PURE__ */ react.createElement("div", { style: { display: "flex", flexDirection: "column", alignItems: "center" } }, /* @__PURE__ */ react.createElement(
      esm.Img,
      {
        src: images[0],
        style: {
  ...
  )), /* @__PURE__ */ react.createElement(esm.Sequence, { from: titleDuration + contentDuration, durationInFrames: outroDuration }, /* @__PURE__ */ react.createElement(
    esm.AbsoluteFill,
    {
      style: {
        display: "flex",
...
;// ./src/remotion/compositions/CorporateTheme.tsx


const CorporateTheme = ({ title, text, images = [], duration }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const safeDuration = typeof duration === "number" && isFinite(duration) && duration > 0 ? duration : 15;
  const titleDuration = Math.floor(fps * 2);
  ...
  const slideInX = (0,esm.interpolate)(frame, [0, 45], [-100, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const contentOpacity = (0,esm.interpolate)(
  ...
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: { backgroundColor: "#1e3a8a" } }, /* @__PURE__ */ react.createElement(
    "div",
    {
      style: {
        position: "absolute",
  ...
  ), /* @__PURE__ */ react.createElement(esm.Sequence, { from: 0, durationInFrames: titleDuration + 30 }, /* @__PURE__ */ react.createElement(
    esm.AbsoluteFill,
    {
      style: {
        display: "flex",
    ...
    images.length > 0 ? /* @__PURE__ */ react.createElement("div", { style: { display: "flex", width: "100%", alignItems: "center" } }, /* @__PURE__ */ react.createElement("div", { style: { flex: 1, marginRight: "60px" } }, /* @__PURE__ */ react.createElement(
      esm.Img,
      {
        src: images[0],
        style: {
      ...
      text
    ))) : /* @__PURE__ */ react.createElement("div", { style: { textAlign: "center", maxWidth: "80%" } }, /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          width: "60px",
...
;// ./src/remotion/compositions/StorytellingTheme.tsx


const StorytellingTheme = ({ title, text, images = [], duration }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const safeDuration = typeof duration === "number" && isFinite(duration) && duration > 0 ? duration : 15;
  const titleDuration = Math.floor(fps * 2.5);
  const contentDuration = Math.max(Math.floor(fps * (safeDuration - 5)), fps);
  const outroDuration = Math.floor(fps * 2.5);
  const titleOpacity = (0,esm.interpolate)(frame, [0, 45], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const titleY = (0,esm.interpolate)(frame, [0, 45], [50, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const contentOpacity = (0,esm.interpolate)(
  ...
  return /* @__PURE__ */ react.createElement(esm.AbsoluteFill, { style: { backgroundColor: "#7c2d92" } }, /* @__PURE__ */ react.createElement(
    "div",
    {
      style: {
        position: "absolute",
    ...
    ), text && /* @__PURE__ */ react.createElement("div", { style: { textAlign: "center", maxWidth: "800px" } }, /* @__PURE__ */ react.createElement(
      "p",
      {
        style: {
          fontSize: 36,
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    __webpack_require__.e(/* import() */ 423).then(__webpack_require__.bind(__webpack_require__, 9423)).then(({ StudioInternals }) => {
