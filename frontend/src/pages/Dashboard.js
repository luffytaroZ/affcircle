...
const Dashboard = () => {
  ...
  const mockSlideshows = [
    { id: 1, title: 'Marketing Campaign Q4', type: 'Text', status: 'Completed', created: '2025-01-15' },
    { id: 2, title: 'Product Launch Video', type: 'Images', status: 'Processing', created: '2025-01-14' },
    { id: 3, title: 'Company Overview', type: 'Text', status: 'Draft', created: '2025-01-13' },
  ]
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex space-x-1 mb-8">
          {[
            { id: 'slideshows', label: 'My Slideshows', icon: 'M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2h3a1 1 0 110 2h-1v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6H3a1 1 0 010-2h3z' },
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-sm">{slideshow.type} • Created {slideshow.created}</p>
                        </div>
                      </div>
